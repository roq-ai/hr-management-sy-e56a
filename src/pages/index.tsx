  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless HR operations with HR Management System: Your one-stop solution for managing employee data, vacations, time tracking, payrolls, and performance evaluations - all in one central place."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517048676732-d65bc937f952?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxIUiUyMG1hbmFnZW1lbnR8ZW58MHx8fHwxNjkyODI2MTAyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless HR operations with HR Management System: Your one-stop solution for managing employee data, vacations, time tracking, payrolls, and performance evaluations - all in one central place.`}
            </Text>
            <Box
